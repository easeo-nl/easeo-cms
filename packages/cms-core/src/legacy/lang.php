...
function t(string $key, array $params = []) : string
{
    ...
    if ($strings === null) {
        $locale = function_exists('site') ? ContentRepository::siteValue('language', 'en') : 'en';
...
{
    $names = ['en' => 'English', 'nl' => 'Nederlands', 'de' => 'Deutsch', 'fr' => 'Français', 'es' => 'Español', 'it' => 'Italiano', 'pt' => 'Português', 'pl' => 'Polski'];
